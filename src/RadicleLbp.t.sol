...
contract Proposer {
    ...
    function proposeExitSale(
        ...
        minAmountsOut[0] = 1_000_000e18;
        minAmountsOut[1] = 20_000_000e6;
    ...
    function proposeExitSaleRaw() public returns (uint) {
        (bool success, bytes memory returnData) = address(gov).call(hex"");
    ...
    function proposeExitSaleAndReturnLoan(
        ...
        targets[4] = router;
        values[4] = 0;
        sigs[4] = "addLiquidity(address,address)";
        calldatas[4] = abi.encode(radToken, usdcToken);
...
contract RadicleLbpTest is DSTest {
    ...
    address constant ADD_LIQUIDITY = 0xB76FC4EbE4fC0CC34AF440Ad79565A68Bfcb095e; // AddLiquidity
    ...
    function test_lbp_proposal_end() public {
        ...
        assertTrue(usdc.balanceOf(address(bPool)) > 20_000_000e6, "CRP Pool has USDC tokens");
        assertTrue(rad.balanceOf(address(bPool)) > 1_000_000e18, "CRP Pool has RAD tokens");

        // Set liquidity amounts.
        {
            AddLiquidity al = AddLiquidity(ADD_LIQUIDITY);
            assertEq(al.admin(), address(this), "Test must be contract admin");
            assertEq(al.radLiquidity(), 0);
            assertEq(al.usdcLiquidity(), 0);
            al.setLiquidity(RAD_LIQUIDITY, USDC_LIQUIDITY, 0, 0);
            assertEq(al.radLiquidity(), RAD_LIQUIDITY);
            assertEq(al.usdcLiquidity(), USDC_LIQUIDITY);
        }
        ...
        Uniswap(UNI_ROUTER).swapExactTokensForTokens(
            10e6,
            9e17,
            path,
            address(0x1),
